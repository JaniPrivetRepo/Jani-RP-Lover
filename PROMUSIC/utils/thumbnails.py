...
async def get_thumb(videoid):
    ...
    try:
        ...
        # Fonts
        arial = ImageFont.truetype("PROMUSIC/assets/font2.ttf", 30)
        font = ImageFont.truetype("PROMUSIC/assets/font.ttf", 30)
        bold_font = ImageFont.truetype("PROMUSIC/assets/font.ttf", 33)
